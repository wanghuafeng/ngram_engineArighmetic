...
def get_sentence_accuracy_top_n():
    '''样本文件中句子的精确度AS'''
    # checkout_filename = os.path.join(PATH, '0709modify', 'checkout.txt')
    # checkout_filename = os.path.join(PATH, '0709modify', 'cut_path_lenght_limit_50_no_smooth.txt')
    # checkout_filename = os.path.join(PATH, 'Kneser_Ney_smooth_checkout_limit_100.txt')
    checkout_filename = os.path.join(PATH, 'Kneser_Ney_smooth_checkout_limit_100_40Gdata.txt')
