...
class Cut_Sentence(object):
    '''  '''
    def __init__(self, base_wordlist_filename):
        self.new_word_list_filename = base_wordlist_filename
        self.combined_set = self._individual_group_set()

    def _individual_group_set(self):
        # self.new_word_list_filename = os.path.join(PATH, 'linguistic_data', 'data', 'base_wrods_weight.txt')
        with codecs.open(self.new_word_list_filename, encoding='utf-8') as f:
    ...
    def cut_without_weight(self, word):
